pub(crate) fn make_group(id: u64, name: String, data_state: &mut DataState) -> u64 {
...
pub(crate) fn list_of_users_groups(id: u64, data_state: &mut DataState) -> Vec<u64> {
    let v = Vec::<u64>;
...
pub(crate) fn find_out_ss(id: u64, gid: u64, data_state: &mut DataState) -> String {
    for cid in data_state.user_in_group {
...
pub(crate) fn join_group(id: u64, gid: u64, data_state: &mut DataState) -> String {
